...
L.TipDepositReagent = 'Click to deposit all reagents.'
L.TipDepositRightReagent = '<Right-Click> to deposit all reagents.'
L.TipGoldOnRealm = '%s Totals'
L.TipHideBag = 'Click to hide this bag.'
L.TipHideReagent = '<Left-Click> to hide this bag.'
...
L.TipShowReagent = '<Left-Click> to show this bag.'
