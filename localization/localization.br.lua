--[[
	Bagnon Localization Information: Brasilian Portuguese
--]]

local L = LibStub('AceLocale-3.0'):NewLocale('Bagnon', 'ptBR')
if not L then return end

--keybinding text
L.ToggleBags = 'Abrir sacos'
...
L.CmdShowInventory = 'Abre os seus sacos'
...
L.TipHideBags = '<Clique Esquerdo> para esconder a lista de sacos.'
L.TipHideSearch = 'Clique para esconder o campo de pesquisa.'
L.TipInventoryToggle = '<Clique Direito> para abrir os sacos.'
L.TipPurchaseBag = 'Clique para comprar uma ranhura no banco.'
L.TipShowBag = 'Clique para mostrar o bag.'
L.TipShowBags = '<Clique Esquerdo> para mostrar a lista de sacos.'
...
L.TipShowInventory = '<Clique Esquerdo> para abrir os sacos.'
